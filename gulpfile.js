...
gulp.task('default', function(cb){
  return runSequence( 'clean:dist', ['html', 'sass-min', 'bootstrapjs', 'mrarejs', 'copy-assets'], ['serve' ,'watch'], cb);
});

gulp.task('build', function(cb){
  return runSequence( 'clean:dist', ['html', 'sass-min', 'bootstrapjs', 'mrarejs', 'copy-assets'], cb);
});
